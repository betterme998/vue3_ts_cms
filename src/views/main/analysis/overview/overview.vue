...
<template>
  <div class="overview">
    ...
    <hy-card title="技术栈">
      ...
      <descriptions title="生产环境依赖" :column="2" :table-datas="dependencies"></descriptions>
      <descriptions title="开发环境依赖" :column="2" :table-datas="devDependencies"></descriptions>
    </hy-card>
    <hy-card title="项目结构">
      <div class="c-left">
        <hy-code language="bash" :code="projectDir"></hy-code>
      </div>
    </hy-card>
    <hy-card title="项目规范">
      <descriptions
...
import descriptions from '@/base-ui/descriptions/src/descriptions.vue'
